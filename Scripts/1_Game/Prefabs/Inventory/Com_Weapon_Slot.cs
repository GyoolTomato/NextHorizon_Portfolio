...
public class Com_Weapon_Slot : Com_Base, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
{
    //
    ...
    Action<Com_Weapon_Slot> _onPointerDown = null;
    Action<Com_Weapon_Slot> _onPointerPressing = null;
    Action<Com_Weapon_Slot> _onPointerUp = null;

    bool _isPressed = false;

    //
    public DataWeapon pData { private set; get; }
    ...
    {
        //
        Init(new DataWeapon(-1, 1, 0, 0, tableInfo), type);
    }
    ...
    public void SetPointerControl(Action<Com_Weapon_Slot> onPointerDown, Action<Com_Weapon_Slot> onPointerPressing, Action<Com_Weapon_Slot> onPointerUp)
    {
